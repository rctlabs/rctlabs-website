...
export default function HomePage() {
  ...
  return (
    <main id="main-content" className="min-h-screen bg-background">
      ...
      <section
        id="core-pillars"
        className="border-y border-border bg-card/30 py-14 md:py-20 transition-colors duration-300"
      >
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {[
              ...
              <Link
                key={pillar.title}
                href={pillar.href}
                className="group relative flex flex-row items-start gap-5 rounded-2xl border border-border bg-card p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-warm-amber/40 overflow-hidden"
              >
