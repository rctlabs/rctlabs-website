...
export const metadata: Metadata = {
  ...
  description: "RCT Ecosystem v2.5.0 documentation — Architecture, APIs, RFCs, and deployment guides.",
}
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-24 md:py-32">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              <span className="text-xs font-mono text-accent bg-accent/10 px-2 py-1 rounded">v2.5.0</span>
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { title: "Testing", desc: "Locust + k6 load testing, OWASP security, Chaos (9 scenarios), E2E (7 flows).", stat: "2,210 tests" },
