...
const layersData: Record<"en" | "th", LayerItem[]> = {
  en: [
    ...
    { id: 7, name: "AI & Machine Learning", icon: Brain, desc: "Inference, cognition, generation, and model coordination at the intelligence core.", microservices: ["FDIA Engine", "JITNA Generator", "Genesis Engine", "Few-Shot Learning"], tech: ["GPT-4o", "Claude", "Gemini", "PyTorch"] },
  ...
  th: [
    ...
    { id: 7, name: "AI & Machine Learning", icon: Brain, desc: "Inference, cognition, generation และการประสาน model ที่เป็นแกนปัญญาของระบบ", microservices: ["FDIA Engine", "JITNA Generator", "Genesis Engine", "Few-Shot Learning"], tech: ["GPT-4o", "Claude", "Gemini", "PyTorch"] },
