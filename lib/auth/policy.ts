...
export const INTERNAL_ROUTE_PREFIXES = ["/studio", "/admin", "/owner", "/monitor", "/analytics", "/test-console", "/websocket"] as const
...
export const PROTECTED_ROUTE_GROUPS: Array<{
  ...
  { prefix: "/studio", requiredRole: "member", fallbackHref: "/auth/signin" },
