...
category: "research"
excerpt: "MEE (Meta Evolution Engine) คือแกนกลางการเรียนรู้ด้วยตัวเองของ RCT Ecosystem — วงรอบวิวัฒนาการเชิงรัฐธรรมนูญที่ประเมิน ปรับ และสร้างอัลกอริทึมใหม่โดยอัตโนมัติ โดยไม่ต้องฝึกโมเดลซ้ำด้วยมือ"
...
- ทำความเข้าใจ [MOIP: การวางแผนเจตนาหลายวัตถุประสงค์](/blog/moip-multi-objective-intent-planning) — อัลกอริทึมตัดสินใจแบบ Pareto-optimal ที่ทำงานคู่กับ MEE ใน RCT kernel pass เดียวกัน
