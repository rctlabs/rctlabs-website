...
*Ittirit Saengow is the sole developer of the RCT Ecosystem. All test counts are from the live test suite (v5.4.5, March 21, 2026). Read the [Testing Methodology](/en/blog/rct-ecosystem-4849-tests-methodology) article for the full 8-level pyramid breakdown.*
